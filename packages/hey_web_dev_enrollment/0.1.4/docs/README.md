# hey_web_dev_enrollment 0.1.4

Development-only LAN discovery, secret-path QR enrollment values, and browser enrollment-page composition for Hey web services.
