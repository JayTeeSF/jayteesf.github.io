...
`hey_web` keeps its public Hey modules and package-specific tests in this repository. Generic package validation, deterministic release construction, checksums, documentation publication, source ZIP creation, and immutable registry publication are delegated to `hey_packager`.
