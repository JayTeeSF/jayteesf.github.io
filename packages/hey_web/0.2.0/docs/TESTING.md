...
therefore uses `Web.serve` and nothing else; `HeyWebServer.service` is
interpreter-lane-only and kept for source compatibility.

Live specs and the receipt use scratch ports 46401 (interpreter spec)
and 46402 (compiled receipt) -- never fleet ports.
