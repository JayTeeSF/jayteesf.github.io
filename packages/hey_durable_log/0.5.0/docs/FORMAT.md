...
Where conversion is possible at all it is an offline step from a verified agreed
snapshot, and where the necessary consensus history cannot be established it is
refused. Old journals are preserved untouched.
